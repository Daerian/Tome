    ...
    <div style={styles.backdrop} onClick={onClose}>
      <div style={styles.card} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={styles.section}>
          <p style={styles.stat}>
            <strong>Armor Class</strong> {s.ac}
          </p>
          <p style={styles.stat}>
        ...
        <div style={styles.section}>
          {s.senses && (
            <p style={styles.stat}>
              <strong>Senses</strong> {s.senses}
            </p>
          )}
          {s.passive && (
            <p style={styles.stat}>
              <strong>Passive Perception</strong> {s.passive}
            </p>
          )}
          {s.languages && (
            <p style={styles.stat}>
              <strong>Languages</strong> {s.languages}
            </p>
          )}
          <p style={styles.stat}>
            <strong>Challenge</strong> {s.cr} (
        ...
        {/* Source */}
        {s.source && <p style={styles.source}>{s.source}</p>}
...
const styles = {
  ...
  divider: {
    margin: '0.35rem 1rem',
    borderTop: '2px solid var(--accent-rule)',
    opacity: 0.6,
  },
  section: {
